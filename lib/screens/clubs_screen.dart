...
class _ClubsScreenState extends State<ClubsScreen> {
  ...
  /// Creating clubs is a Premium feature — nudge Free users to Membership.
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text('Creating clubs is a Premium feature',
                  textAlign: TextAlign.center,
                  style: GoogleFonts.archivo(fontSize: 20, fontWeight: FontWeight.w700, color: AppColors.cream)),
              const SizedBox(height: 10),
              Text('Upgrade to Premium to start your own clubs — public or private. '
                  'You can still join any club on Free.',
                  textAlign: TextAlign.center,
